PRAKRUTI_QUESTIONS_DATA = [
  {
    ...
    options: [
      ...
      { text: "I tend to have a solid, soft, or heavier build, with smooth or moist skin, and I gain weight pretty easily.", dosha: "kapha" }
    ]
  },
  {
  ...
  },
  {
    ...
    options: [
      ...
      { text: "My mind is calm and steady. I don’t rush decisions, and I like thinking things through with care.", dosha: "kapha" }
    ]
  },
  {
    ...
    options: [
      ...
      { text: "I’m deeply loving and loyal, but I can get stuck in sadness or hold onto feelings longer than I want to.", dosha: "kapha" }
    ]
  },
  {
    ...
    options: [
      ...
      { text: "I’m more gentle and thoughtful in how I share, often speaking from the heart.", dosha: "kapha" }
    ]
  },
  {
    ...
    options: [
      ...
      { text: "I take my time, feel things out emotionally, and wait until something just feels right.", dosha: "kapha" }
    ]
  },
  {
    ...
    options: [
      ...
      { text: "When I’m in a loving space, resting, nurturing others, or enjoying simple comforts.", dosha: "kapha" }
    ]
  }
].freeze